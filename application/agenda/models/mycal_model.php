...
function get_appuntamento($id,$id_titolare) {
 ...
 function getdata_appuntamenti($id_usr,$filter,$off=0,$lim=6 ) {
  ...
  $sql.=' AND id_titolare in (SELECT id_titolare from responsabilititolari where id_responsabile='.$id_usr.')';
