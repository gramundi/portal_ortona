...
$('.day_num').click(function() {
			...
			titolare="<?php echo $titolare ?>";
                        ...
                        //stesso Anno check Mese
                        else if ((parseInt(year,10) - parseInt(yy,10)==0)
                             && ((parseInt(month,10) - parseInt(mm,10)) < 0 ) ){
                                    alert('impossibile inserire appuntamento');
                                    return false;
                              }
                        //Stesso Anno stesso Mese check day
                        else if ((parseInt(year,10) - parseInt(yy,10)  == 0)
                               &&(parseInt(month,10) - parseInt(mm,10) == 0)
                               &&((parseInt(day_num,10) - parseInt(gg,10)) < 0 )){
                            alert('impossibile inserire appuntamento');
                            return false;
                        }
